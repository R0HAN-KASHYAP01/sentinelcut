...
from sentinelcut_ai.profanity_detection.normalizer import normalize_word
...
def _load_dictionaries():
    # processing_pipeline.py lives in sentinelcut_ai/pipeline/, dictionaries
    # live in sentinelcut_ai/data/dictionaries/ — two levels up, then in.
    pipeline_dir = os.path.dirname(os.path.abspath(__file__))
    data_dir = os.path.join(pipeline_dir, "..", "data", "dictionaries")
    with open(os.path.join(data_dir, "profanity_dict.json"), "r", encoding="utf-8") as f:
        profanity_dict = json.load(f)
    with open(os.path.join(data_dir, "phrase_dict.json"), "r", encoding="utf-8") as f:
